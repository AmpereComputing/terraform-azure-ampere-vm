...
module "azure-ampere-vm" {
     ...
     #  vm_size                  = var.vm_size
        location                 = "westus2"
        azure_vm_count           = 1
        azure_os_image           = "opensuse11"
        instance_prefix          = "azure-ampere-vm-opensuse-11"
...
runcmd:
  - curl -fsSL https://download.docker.com/linux/opensuse/gpg | sudo apt-key add -
...
You now should have a fully running and configured OpenSUSE instance. When finished you will need to execute the 'destroy' command to remove all
